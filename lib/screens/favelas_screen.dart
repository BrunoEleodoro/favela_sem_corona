...
class FavelasScreen extends StatefulWidget {
  static const id = 'favelas_screen';
...
class _FavelasScreenState extends State<FavelasScreen> {
  ...
  void initState() {
    ...
    super.initState();
    selectedItem = globals.selected_favela ?? "selecione";
    getDataFromAPI();
    ...
    while (i < globals.favelas['features'].length) {
      favelas_dropdown.add(DropdownMenuItem(
        value: globals.favelas['features'][i]['attributes']['Bairro'],
        child: Text(globals.favelas['features'][i]['attributes']['Bairro']),
      ));
      i++;
    }
  }
