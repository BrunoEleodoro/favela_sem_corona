...
class MoonPayWrapper{
  ...
  Future<bool> tokenGen (String email) async {
    var url = "https://api.moonpay.io/v2/customers/email_login?apiKey=${secrets.moonpay_key}";
  ...
  Future<dynamic> getToken( email, otp) async {
    var url = "https://api.moonpay.io/v3/customers/email_login?apiKey=${secrets.moonpay_key}";
    var resp = await http.post(
        url,
        headers: {
          "Content-Type" : "application/json"
  ...
  Future<dynamic> putDetails(jwt, String firstName, String lastName) async {
    const url ="https://api.moonpay.io/v3/customers/me";
    print(firstName);
